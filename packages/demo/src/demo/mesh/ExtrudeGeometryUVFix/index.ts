...
export class ExtrudeGeometryUVFix {
	...
	async render() {
		const shape1 = new THREE.Shape(
			[
				[121.48164735399996, 31.250485472499975],
				[131.48162582500004, 51.250439568300067],
				[141.48163659900013, 61.250347916899955],
				[151.48166890100003, 71.250320506299943],
				[161.4819488280001, 81.250339660000122],
				[171.48195959200007, 91.250376364600015],
				[181.48193804699997, 101.250513825800112],
				[121.48164735399996, 31.250485472499975],
			].map(item => new THREE.Vector2(item[0], item[1]))
		);
		const shape2 = new THREE.Shape(
			[
				[221.48164735399996, 31.250485472499975],
				[231.48162582500004, 51.250439568300067],
				[241.48163659900013, 61.250347916899955],
				[251.48166890100003, 71.250320506299943],
				[261.4819488280001, 81.250339660000122],
				[271.48195959200007, 91.250376364600015],
				[281.48193804699997, 101.250513825800112],
				[221.48164735399996, 31.250485472499975],
			].map(item => new THREE.Vector2(item[0], item[1]))
		);
		const shapes = [shape1];
